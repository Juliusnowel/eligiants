...
$headline       = $attributes['headline']       ?? "Why We're a Little Different?";
$paragraphOne   = $attributes['paragraphOne']   ?? "We don’t sell flights, we share secrets. Ilegiant Air Tickets is for curious Asian travelers who want to fly smarter, go deeper, and explore with meaning.";
$paragraphTwo   = $attributes['paragraphTwo']   ?? "Get smart routes, local insights, and travel tips made for wanderers who chase memories, not mileage points.";
...
$imgRadius      = isset( $attributes['imageBorderRadius'] ) ? intval( $attributes['imageBorderRadius'] ) : 24;
